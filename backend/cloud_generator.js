...
const imagesToLoad = [
...

  {
    ...
    path: `static/images/4096x2048/earth.jpg`,
    loaded: false,
    imageData: null
  },
  {
    type: 'EARTH_WITHOUT_CLOUDS_NIGHT',
    path: `static/images/4096x2048/earth-night.jpg`,
    loaded: false,
    imageData: null
  },
  {
...
function saveImageResolutions(image, filename, formats) {
  ...
  formats.forEach(format => {
    // Skip 8192x4096 resolution (i=0) - start from i=1 to temporarily disable largest resolution
    for (let i = 1; i < 4; i++) {
      const scale = 2 ** i;
