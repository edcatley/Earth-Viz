...
export class ParticleSystem {
    constructor() {
        ...
        Object.defineProperty(this, "colorStyles", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
     ...
     */
    initializeParticleField(windProduct, globe, mask, view) {
     ...
     */
    createField(columns, bounds, validPositions) {
