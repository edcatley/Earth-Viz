...
export class WeatherDataService {
    get baseUrl() { return '/earth-viz/api/weather'; }
    constructor() {
     ...
     */
    async fetchScalarData(parameter, level, date) {
     ...
     */
    async fetchVectorData(uParam, vParam, level, date) {
     ...
     */
    createVectorGridBuilder(vectorData) {
        ...
        const interpolateFunction = (x, y, g00, g10, g01, g11) => {
            const rx = (1 - x);
            const ry = (1 - y);
     ...
     */
    createScalarGridBuilder(scalarData) {
