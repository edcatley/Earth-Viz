...
export class WebGLMeshRenderer {
    constructor() {
        ...
        Object.defineProperty(this, "supportsUint32Indices", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        ...
        // Mesh buffers
        Object.defineProperty(this, "meshBuffers", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "currentProjectionType", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
     ...
     */
    loadMeshData(geojson, name, style) {
     ...
     */
    render(globe, meshesToRender, viewport) {
     ...
     */
    geojsonToGeometry(geojson, lineWidth) {
        const vertices = [];
        const indices = [];
     ...
     */
    lineToQuadToTriangle(coordinates, vertices, indices, vertexIndex) {
        ...
        for (let i = 0; i < coordinates.length - 1; i++) {
            ...
            indices.push(baseIndex, baseIndex + 1, baseIndex + 2, // tri 1
     ...
     */
    createMeshBuffer(geometry, name, style) {
        if (!this.gl)
            return null;
    ...
    setUniforms(globe, viewport) {
        if (!this.gl || !this.locations || !globe.projection)
            return;
        ...
        if (projectionType === 'orthographic') {
            ...
            const qe = (value, range) => ((value % range) + range) % range;
            let i = qe(φ0 + 90, 360);
            let flip = 180 < i ? -1 : 1;
            if (flip < 0) {
                φ0 = 270 - i;
     ...
     */
    createShaderProgram(projectionType) {
        if (!this.gl)
            return false;
...
//# sourceMappingURL=WebGLMeshRenderer.js.map