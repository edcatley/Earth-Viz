...
// Type declarations for global GRIB2 functions
declare global {
    interface Window {
        decodeGRIB2File: (buffer: ArrayBuffer) => any[];
        GRIB2: any;
    }
    const decodeGRIB2File: (buffer: ArrayBuffer) => any[];
    const GRIB2: any;
}
...
export class Grib2Service {
    ...
    private async parseGrib2(arrayBuffer: ArrayBuffer): Promise<Grib2Data[]> {
        if (typeof decodeGRIB2File === 'undefined') {
            throw new Error('GRIB2 library not loaded');
        }
